package com.ecore.roles.web.handler;
...
public class DefaultExceptionHandler {
    ...
    @ExceptionHandler({UserDoesntBelongTeamException.class})
    public ResponseEntity<ErrorResponse> handle(UserDoesntBelongTeamException exception) {
